/*
 * File: _coder_main_entry_point_info.c
 *
...
/* Include Files */
#include "_coder_main_entry_point_info.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("main_entry_point"));
...
/*
 * File trailer for _coder_main_entry_point_info.c
 *
 * [EOF]
 */
